class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      { x: width / 2 - 130, y: height - 1500, image: obstacle2Image },
      { x: width / 2 + 210, y: height - 1700, image: obstacle2Image },
      { x: width / 2 - 120, y: height - 3200, image: obstacle2Image },
     
      { x: width / 2 - 180, y: height - 4100, image: obstacle2Image },
